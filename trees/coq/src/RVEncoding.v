...
Definition opcode_SCHED     := Ob~0~0~0~1~0~1~1.
...
Definition funct3_CEQZ := Ob~1~0~1.
Definition funct7_CEQZ := Ob~0~0~0~0~1~1~1.

Definition funct3_CNEZ := Ob~1~1~1.
Definition funct7_CNEZ := Ob~0~0~0~0~1~1~1.
...
Definition funct3_TMC    := Ob~0~0~0.
Definition funct3_WSPAWN := Ob~0~0~1.
Definition funct3_SPLIT  := Ob~0~1~0.
Definition funct3_JOIN   := Ob~0~1~1.
Definition funct3_BAR    := Ob~1~0~0.
Definition funct3_PRED   := Ob~1~0~1.
...
Definition funct7_FCVT_S_D := Ob~0~1~0~0~0~0~0.
Definition funct7_FCVT_D_S := Ob~0~1~0~0~0~0~1.
...
Definition rs2_FCVT_S_D := Ob~0~0~0~0~1.
Definition rs2_FCVT_D_S := Ob~0~0~0~0~0.
