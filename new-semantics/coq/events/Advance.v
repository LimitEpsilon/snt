  ...
  Proof.
    ...
    - exploit IHEVAL1; eauto.
      ...
      + exists (Call E v2').
        ...
        econstructor; eauto.
        erewrite equiv_semantics.
        eauto.
        eapply linked_lc_wvl in LINK; eauto. inv LINK. inv VAL.
        eapply Eval_lc in EVAL1; auto. inv EVAL1.
        eapply Eval_lc in EVAL2; auto.
